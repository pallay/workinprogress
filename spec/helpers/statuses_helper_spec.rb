...
describe StatusesHelper do
  ...
  describe "#today_tomorrow_or_day" do
    it "should return the correct value for todays date" do
      today_tomorrow_or_day(Time.now.utc).should eql("Today")
    end
    
    it "should return the correct value for yesterdays date" do
      today_tomorrow_or_day(1.day.ago.utc).should eql("Yesterday")
    end
    
    it "should return the correct value for any other date" do
      today_tomorrow_or_day(4.days.ago.utc).should eql(4.days.ago.strftime("%A"))
    end
  end
